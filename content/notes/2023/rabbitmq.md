...
- ## what arer the best practice regarding channel and connection
...
- ## How to Handle failures in QUEUE
    
  -  If we want to retry if the consumer get failed when processing the data
...
- ## Best practice
    ...
    - [https://www.youtube.com/watch?v=ez9kQEhHsnc&t=68s](https://www.youtube.com/watch?v=ez9kQEhHsnc&t=68s) (what we learned form running 1k queue cloudamp)
        1. Keep connection and channle as low as possible
        2. seprate connection for pub and consume
...
- ## Resources
    ...
    1. [https://www.rabbitmq.com/streams.html](https://www.rabbitmq.com/streams.html)
    2. [https://youtu.be/HzPOQsMWrGQ](https://youtu.be/HzPOQsMWrGQ)
    3. [https://github.com/rabbitmq/internals](https://github.com/rabbitmq/internals) (This project aims to explain how RabbitMQ works internally.)
    4. [https://youtu.be/fNbdgWe5Tbs](https://youtu.be/fNbdgWe5Tbs) 
    5. 
